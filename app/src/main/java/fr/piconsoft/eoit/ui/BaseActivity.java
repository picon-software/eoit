...
import fr.piconsoft.eoit.injection.ActivityModule;
...
public abstract class BaseActivity extends ActionBarActivity {
	...
	protected ProgressActionView progressActionView;
	...
	protected void initProgressActionView(MenuItem menuItem,
										  OnProgressListener listener,
										  boolean progressOnly) {
		progressActionView = (ProgressActionView) MenuItemCompat.getActionView(menuItem);
		progressActionView.setListener(listener);
		progressActionView.setProgressOnly(progressOnly);
	}

	protected void initProgressActionView(MenuItem menuItem,
										  boolean progressOnly) {
		initProgressActionView(menuItem, null, progressOnly);
	}

	protected void setActionBarInderterminate(boolean indeterminate) {
		if(progressActionView != null) {
			if(indeterminate) {
				progressActionView.startProgress();
			} else {
				progressActionView.stopProgress();
			}
		}
	}
