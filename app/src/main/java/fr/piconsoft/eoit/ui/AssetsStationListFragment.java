 ...
 */
public class AssetsStationListFragment extends StationListFragment {

	public AssetsStationListFragment() {
		sectionTitleId = R.string.station_assets_title;
	}
	...
	protected Loader<Cursor> getCursorLoader(int id, Bundle args) {
		return new CursorLoader(
				...
				"s." + Station._ID + " IN ( SELECT DISTINCT " +
						Stock.COLUMN_NAME_LOCATION_ID + " FROM " + Stock.TABLE_NAME + ")",
				null,
				null);
	}
