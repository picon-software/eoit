...
public final class Stations {
	...
	private static Station tradeStation = new Stations.Station();
	private static Station productionStation = new Stations.Station();

	private Stations() { }

	public static Station getProductionStation() {
		return productionStation;
	}

	public static Station getTradeStation() {
		return tradeStation;
	}

	public static void setTradeStation(Station tradeStation) {
		Stations.tradeStation = tradeStation;
	}

	public static void setProductionStation(Station productionStation) {
		Stations.productionStation = productionStation;
	}

	public static void clear() {
		tradeStation = new Stations.Station();
		productionStation = new Stations.Station();
	}

	public static void initTradeStation(int regionId, int solarSystemId, int stationId, String stationName, float standing) {
	...
	public static void initProdStation(int regionId, int solarSystemId, int stationId, String stationName, float standing) {
