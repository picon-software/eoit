 ...
 */
public class ReactionPriceCalculatorHelper extends PriceCalculatorHelperBase {
	...
	public static Cursor retreiveData(ContentResolver contentResolver, int itemId) {
		...
		return contentResolver.query(
				ContentUris.withAppendedId(ItemMaterials.CONTENT_ITEM_ID_URI_BASE_PRICES_FOR_REACTION, itemId),
